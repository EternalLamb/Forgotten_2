...
if (!is_dead) {
    ...
    var rango_ataque = 150; // Ajusta el rango de ataque según sea necesario
    ...
    if (Atacando && global.Golpeando == false) {
        ...
        if (image_index >= 3 && image_index <= 20 && place_meeting(x-1,y,Obj_Player) || place_meeting(x-1,y,Obj_Player) ) {
        ...
        if (image_index >= image_number - 1) {
            Atacando = false;
            sprite_index = Spr_enemigo1_move; // Cambia al sprite de movimiento
