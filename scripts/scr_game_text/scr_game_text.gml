...
{	
	...
	scr_text("Vaya no la habia visto, se parece mucho a algo que conozco.... ", "Player");
	scr_text("Uhm?", "Shadow", -1);
	scr_text("Quiza no es importante...", "Player");
	break;
	...
	scr_text("N-no importa, hare lo que sea para ayudarte, eres mi unico y mejor amigo y hare lo que sea para ayudarte", "Shadow", -1);
	...
	scr_text("Si, la bestia es.... una bestia *risita* esta con su poder oscuro obliga a los habitantes del bosque a proteger su guarida, corrompiendo sus formas y formas de pensar", "Shadow", -1);
